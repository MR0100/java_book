---
title: "Core Java & OOP — Testing Fundamentals"
slug: l1-testing-fundamentals
level: L1
...
|---|-------|--------------|--------|
| 01 | Unit testing with JUnit 5 | `T01-unit-testing-with-junit-5.md` | planned |
| 02 | Assertions (AssertJ, Hamcrest) | `T02-assertions-assertj-hamcrest.md` | planned |
| 03 | Mocking with Mockito | `T03-mocking-with-mockito.md` | planned |
| 04 | Test doubles (stub/mock/spy/fake) | `T04-test-doubles-stub-mock-spy-fake.md` | planned |
| 05 | TestNG (alternative) | `T05-testng-alternative.md` | planned |
